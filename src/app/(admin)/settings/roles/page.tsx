  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="h-[100px] rounded-xl relative overflow-hidden bg-gradient-to-br from-sky-500 via-sky-500 to-sky-600 p-4 shadow-lg">
        ...
        <div className="h-[100px] rounded-xl relative overflow-hidden bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600 p-4 shadow-lg">
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div className="flex items-center justify-between">
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/20">
        ...
        <div className="h-[100px] rounded-xl relative overflow-hidden bg-gradient-to-br from-sky-400 via-sky-400 to-sky-500 p-4 shadow-lg">
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div className="flex items-center justify-between">
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/20">
