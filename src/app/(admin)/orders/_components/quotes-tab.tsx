...
> = {
  ...
  sent: { label: '送付済み', color: 'text-sky-600', icon: Send, bgColor: 'bg-sky-100' },
  negotiating: { label: 'やりとり中', color: 'text-sky-600', icon: MessageSquare, bgColor: 'bg-sky-100' },
  ...
  ordered: { label: '注文済み', color: 'text-sky-600', icon: ShoppingCart, bgColor: 'bg-sky-100' },
};
